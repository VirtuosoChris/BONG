...
ball doCollision(ball tBall)
{
    ...
    if (MainBall.round == gameRound || MainBall.round == 4)
    {
        ...
        if (passed)
        {
            ...
            cBall.xVec = cBall.xVec + MainBall.xVec;

            cBall.yVec = -cBall.yVec;
            cBall.yVec = cBall.yVec + MainBall.yVec;
            ...
            MainBall.xVec = -MainBall.xVec;
            MainBall.xVec = cBall.xVec + MainBall.xVec;
